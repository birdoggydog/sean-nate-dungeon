...
public class BodyLocationConstants {
	 ...
	 * 
	 */
	public static final int[] armorLocations = {HEAD_LOC,NECK_LOC,LEFT_SHOULDER_LOC,RIGHT_SHOULDER_LOC,LEFT_UPPER_ARM_LOC,RIGHT_UPPER_ARM_LOC,LEFT_LOWER_ARM_LOC,RIGHT_LOWER_ARM_LOC
	...
	public static final int[] clothesLocations = {HEAD_LOC,NECK_LOC,LEFT_SHOULDER_LOC,RIGHT_SHOULDER_LOC,LEFT_UPPER_ARM_LOC,RIGHT_UPPER_ARM_LOC,LEFT_LOWER_ARM_LOC,RIGHT_LOWER_ARM_LOC
	...
	public static final int[] flairLocations= {LEFT_EYE_LOC,RIGHT_EYE_LOC,LEFT_EAR_LOC,RIGHT_EAR_LOC,RIGHT_WRIST_LOC,LEFT_WRIST_LOC,RIGHT_FINGER_LOC,LEFT_FINGER_LOC,RIGHT_ANKLE_LOC,LEFT_ANKLE_LOC,WAIST_LOC};
	public static final int[] weaponsLocations = {LEFT_HAND_LOC,RIGHT_HAND_LOC,BACK_LOC};
}
